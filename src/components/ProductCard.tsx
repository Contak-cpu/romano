...
import { ChevronLeft, ChevronRight, Calendar, Fuel, Settings, Zap, Eye, Gauge } from 'lucide-react';
...
const ProductCard: React.FC<ProductCardProps> = ({ product, onViewDetails }) => {
  ...
  const handleWhatsAppContact = (e: React.MouseEvent) => {
    e.stopPropagation();
    const message = `Hola! Me interesa el ${product.brand} ${product.model} ${product.year} que vi en su página web. ¿Podrían darme más información?`;
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
        {/* Contenido superior */}
        <div>
          {/* Título del producto - Ancho completo */}
          ...
          {/* Descripción breve */}
          <p className="text-gray-700 text-sm mb-4 leading-relaxed min-h-[60px]">
            {product.description}
          </p>
