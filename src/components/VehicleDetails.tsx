        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex justify-between items-start mb-4 sm:mb-6">
            <div className="flex-1 pr-4">
              ...
              <p className="text-lg sm:text-xl text-gray-600">{vehicle.year}</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div 
            ref={imageRef}
            className="relative h-64 sm:h-96 mb-4 sm:mb-6 rounded-xl overflow-hidden touch-pan-y"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6 sm:mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Descripción</h3>
              ...
              {/* Specifications */}
              <div className="mb-6 sm:mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Especificaciones Técnicas</h3>
              ...
              {/* Features */}
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Equipamiento y Características</h3>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 sticky top-6">
                ...
                {vehicle.available && (
                  <div className="space-y-3 sm:space-y-4">
                    <button
                      ...
                      className="w-full bg-green-500 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-semibold hover:bg-green-600 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 sm:space-x-3 shadow-lg touch-manipulation"
                    >
                ...
                <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
                  <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">¿Tenés dudas?</h4>
